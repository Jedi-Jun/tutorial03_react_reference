...
class App extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      contents:[
        {id:1, title:'HTML', desc:'HTML is for the documents..'},
        {id:2, title:'CSS', desc:'CSS stands for Cascade Style Sheet..'},
        {id:3, title:'JavaScript', desc:'JavaScript is the key point to make..'}
      ]
    }
  }
      ...
      <div className="App">
        ...
        <Control 
          ...
          onChangeMode={function(_mode){
            ...
            if(_mode === 'delete' && window.confirm('Do you want to delete?')){
